...
\`\`\`r \# Install devtools if needed install.packages("devtools")

# Install the package from GitHub

devtools::install_github("anaceiahasse/PopIn")

This repository can also be downloaded from Zenodo at [![DOI](https://zenodo.org/badge/962905590.svg)](https://doi.org/10.5281/zenodo.19008430).
